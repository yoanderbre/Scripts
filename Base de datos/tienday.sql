...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-04-2025 a las 03:12:24
...
--
ALTER TABLE `prendas`
  MODIFY `id_prenda` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
